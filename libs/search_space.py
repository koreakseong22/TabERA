...
def get_search_space(
    ...
    # Default matches the CLI (commitment is off, §10). With False here any
    # caller that omits the argument searches a weight the forward pass
    # never reads -- and reproduce.py then trains with it.
